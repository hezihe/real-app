...
class Signup extends Form {
  ...
  doSubmit = async () => {
    const data  = { ...this.state.data }; // Deep Clone (copy)
    data.biz = false;
    ...
    try {
      ...
      if (ex.response && ex.response.status === 400) { //response comes from axios error promise
  ...
  render() {
    ...
    return (
      <div className="container">
        <PageHeader titleText="Signup for Business Cards App" />
        <div className="row">
